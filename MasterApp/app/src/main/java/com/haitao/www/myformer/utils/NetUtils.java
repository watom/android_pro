...
public class NetUtils {
    ...
    public static void getRequest(final String url, final Callback callback) {
    ...
    public static void postRequest(final String url, final String content, final Callback callback) {
        final Handler handler = new Handler();
        new Thread(new Runnable() {
            @Override
            public void run() {
