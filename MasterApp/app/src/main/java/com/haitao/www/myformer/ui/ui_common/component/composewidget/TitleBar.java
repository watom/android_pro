package com.haitao.www.myformer.ui.ui_common.component.composewidget;
...
public class TitleBar extends RelativeLayout {
    ...
    public TitleBar(Context context, AttributeSet attrs, int defStyle) {
        ...
        TypedArray typedArray = context.obtainStyledAttributes(attrs, R.styleable.TitleBar_View);
        deployTypedArray(typedArray);
        initView(context);
    }

    private void deployTypedArray(TypedArray typedArray) {
        if (typedArray != null) {
            mTitleText = typedArray.getString(R.styleable.TitleBar_View_titleBar_text);
            typedArray.recycle();
        }
    }
    ...
    private void initView(final Context context) {
        ...
        mBackIconView = findViewById(R.id.iv_back_right);
        mTitleIconView = findViewById(R.id.iv_title_right);
        mRightImageView1 = findViewById(R.id.imageview_1);
        mRightImageView2 = findViewById(R.id.imageview_2);
        mBackTextView = findViewById(R.id.tv_left);
        ...
        mMain = findViewById(R.id.rl_titlebar);
	...
	public void setBackTextView(String text) {
