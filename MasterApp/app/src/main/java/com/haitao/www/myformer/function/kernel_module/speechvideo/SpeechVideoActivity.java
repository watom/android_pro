package com.haitao.www.myformer.function.kernel_module.speechvideo;
...
public class SpeechVideoActivity extends AppCompatActivity {
    ...
    private static final String LOG_TAG = SpeechVideoActivity.class.getSimpleName();
