    ...
    public boolean onTouchEvent(MotionEvent e) {
        ...
        switch (e.getAction()){
            case MotionEvent.ACTION_DOWN:
                ...
                if (item != null) {
                    //获取当前选中的Item
                    DragRecyclerAdapter.ViewHolder viewHolder = (DragRecyclerAdapter.ViewHolder) getChildViewHolder(item);
                    mCurItemLayout = viewHolder.ll_drag_gridView;
                    //找到具体元素（这与实际业务相关了）
//                    mLlHidden = mCurItemLayout.findViewById(R.id.grid_item_image);
//                    mItemDelete = mCurItemLayout.findViewById(R.id.grid_item_title);
