...
public class ScreenShotListenManager {
    ...
    private ScreenShotListenManager(Context context) {
        ...
        if (sScreenRealSize == null) {
            ...
            if (sScreenRealSize != null) {
                Log.e("截屏","Screen Real Size: " + sScreenRealSize.x + " * " + sScreenRealSize.y);
            } else {
                Log.e("截屏","Get screen real size failed.");
            }
        }
    }
    ...
    private void handleMediaContentChange(Uri contentUri) {
        ...
        try {
            ...
            if (cursor == null) {
                Log.e("截屏","Deviant logic.");
                return;
            }
            if (!cursor.moveToFirst()) {
                Log.e("截屏","Cursor no data.");
                return;
            }
    ...
    private void handleMediaRowData(String data, long dateTaken, int width, int height) {
        Log.e("截屏","ScreenShot: path --- " + data + "; size = " + width + " * " + height
                + "; date = " + dateTaken);
        if (checkScreenShot(data, dateTaken, width, height)) {
            ...
            Log.e("截屏","Media content changed, but not screenshot: path = " + data
