 ...
 * 自定义组合控件
 */
public class CustomAssembleWidgetActivity extends RelativeLayout {
    private  Button titleBarLeftBtn;
    private Button titleBarRightBtn;
    private TextView titleBarTitle;

    public CustomAssembleWidgetActivity(Context context, AttributeSet attrs) {
        super(context, attrs);
        LayoutInflater.from(context).inflate(R.layout.layout_custom_assemble_widget, this, true);
