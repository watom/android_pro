...
public class OptionItemView extends LinearLayout {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        for (int i = 0; i < typedArray.getIndexCount(); i++) {
            ...
            switch (attr) {
                ...
                case R.styleable.OptionItemView_divider_align_to_title:
                    ...
                    break;
                case R.styleable.OptionItemView_dividerLine_right_pading:
                   float right_padding= typedArray.getDimension(attr, 0.0f);
                    dividerLine.setPadding(0, 0, (int) right_padding, 0);
                    break;
                case R.styleable.OptionItemView_dividerLine_left_pading:
                    float left_padding= typedArray.getDimension(attr, 0.0f);
                    dividerLine.setPadding((int) left_padding, 0,0, 0);
                    break;
                default:
                    break;
            }
        ...
        if (alignDividerToTitle) {
            LayoutParams layoutParams = (LayoutParams) dividerLine.getLayoutParams();
