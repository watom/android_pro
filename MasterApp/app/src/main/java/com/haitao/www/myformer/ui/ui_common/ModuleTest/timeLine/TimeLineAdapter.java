...
public class TimeLineAdapter extends RecyclerView.Adapter {
    ...
    private List<TraceData> traceDataList = new ArrayList<>(1);
    private static final int TYPE_TOP = 0x0000;
    private static final int TYPE_NORMAL= 0x0001;

    public TimeLineAdapter(Context context, List<TraceData> traceDataList) {
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (getItemViewType(position) == TYPE_TOP) {
            ...
            itemHolder.tvDot.setBackgroundResource(R.drawable.cell_round_dot);
        ...
        itemHolder.bindHolder(traceDataList.get(position));
    }
    ...
    public class ViewHolder extends RecyclerView.ViewHolder{
        ...
        public void bindHolder(TraceData trace) {
            tvAcceptTime.setText(trace.getTime());
            tvAcceptStation.setText(trace.getStation());
        }
    }
}
